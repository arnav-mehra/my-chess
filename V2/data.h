...
#define lsb(b) ((U32) __builtin_ctzll(b))
#define msb(b) ((U32) __builtin_clzll(b))
#define pop(b) ((U32) __builtin_popcountll(b))
...
void init_tables() {
  for (int p = 0; p < 6; p++) {
    for (int sq = 0; sq < 64; sq++) {
      ...
      mg_table[p + 6][sq] = -mg_value[p] - mg_pesto_table[p][sq ^ 56];
      eg_table[p + 6][sq] = -eg_value[p] - eg_pesto_table[p][sq ^ 56];
    }
  }
}
